  ...
  return (
    <div className="relative w-full p-4 my-80 lg:my-0">
      ...
      <Image
        width={55}
        height={55}
        className="w-[94px] absolute lg:top-40 md:left-96 left-52 pb-5 lg:pb-0 "
      ...
      <Image
        width={55}
        height={55}
        className="absolute lg:right-1/2 lg:top-60 w-[67px] right-5 "
      ...
      <Image
        width={55}
        height={55}
        className="w-[84px] lg:right-40 lg:top-[500px] absolute "
      ...
      <img
        className="w-[90px] lg:absolute lg:top-0 lg:right-96 lg:top-40"
        src="/assets/Ellipse 270.png"
        alt=""
      />
      <img
        className="w-20 absolute right-5 lg:right-0 lg:left-96 lg:top-[700px] "
        src="/assets/Ellipse 267.png"
        alt=""
      />
      <img
        className="w-[100px] absolute lg:top-96 left-40"
        src="/assets/Ellipse 268.png"
        alt=""
      />
      <img
        className="w-[113px] lg:right-96 mt-20 lg:mt-0 lg:top-[700px] absolute "
