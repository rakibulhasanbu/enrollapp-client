    ...
    <div>
      ...
      <div className="relative w-full p-4 my-28 lg:my-0">
        <Image
          width={55}
          height={55}
          className="lg:w-[80px] w-10 absolute xl:top-48 xl:left-80 md:left-96 lg:left-40 pb-5 lg:pb-0 -top-16 left-20 "
        ...
        <Image
          width={55}
          height={55}
          className="absolute lg:right-1/2 lg:top-48  xl:right-1/2 xl:top-48 lg:w-[67px] w-8 right-5 -top-16 "
        ...
        <Image
          width={55}
          height={55}
          className="lg:w-[84px] w-10 hidden lg:block xl:right-48 lg:top-[400px] xl:top-[500] absolute "
        ...
        <div className=" lg:h-[80vh] lg:flex lg:flex-col lg:justify-center lg:items-center">
          <div className="lg:w-[50%] relative -mt-2 lg:mt-0 ">
            <Image
              src="/assets/comma.png"
              alt=""
              width={55}
              height={55}
              className="lg:w-[69px] absolute w-5  "
            />
            ...
            <Image
              ...
              width={55}
              height={55}
              className="lg:w-[69px] absolute lg:right-0 right-2 w-5"
            />
          </div>
        </div>
        <Image
          className="lg:w-[70px] lg:absolute  xl:right-80 xl:top-48 w-8 "
        ...
        />
        <Image
          className="w-[80px] absolute lg:top-96 hidden lg:block left-40 lg:left-60"
        ...
        />
        <Image
          className="lg:w-[80px] w-10 lg:right-96 mt-20 lg:mt-0 xl:top-[600px] absolute hidden lg:block  left-30 "
