...
export const PartnerDetails = () => {
  return (
    <div className="relative w-full p-4 my-80 lg:my-0">
      <img
        className="w-[55px] lg:left-10 absolute top-40 lg:top-0  hidden lg:block"
        src="/assets/Ellipse 266.png"
        alt=""
      />
      <img
        className="w-[94px] absolute lg:top-10 left-52 pb-5 lg:pb-0"
        src="/assets/Ellipse 263.png"
        alt=""
      />
      <img
        className="absolute lg:right-20 lg:top-40 w-[67px] right-5 lg:right-0"
        src="/assets/Ellipse 264.png"
        alt=""
      />
      <img
        className="w-[84px] lg:right-10 lg:top-72 absolute "
      ...
      <img
        className="w-[90px] lg:absolute lg:top-0 lg:right-44"
        src="/assets/Ellipse 270.png"
        alt=""
      />
      <img
        className="w-20 absolute right-5 lg:right-0 lg:left-40 lg:top-[400px]"
        src="/assets/Ellipse 267.png"
        alt=""
      />
      <img
        className="w-[100px] absolute lg:top-48 left-40"
        src="/assets/Ellipse 268.png"
        alt=""
      />
      <img
        className="w-[113px] lg:right-40 mt-20 lg:mt-0 lg:top-[400px] absolute"
